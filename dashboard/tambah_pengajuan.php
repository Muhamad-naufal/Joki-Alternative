          ...
          <div class="card position-relative">
            ...
            <div class="card-body">
              <form action="proccess/add_pengajuan.php" method="post" enctype="multipart/form-data">
                    ...
                    foreach ($products as $product) { ?>
                      <div class="d-flex justify-content-between align-items-center">
                        <div class="container">
                          <div class="row">
                            <div class="col">
                              <img src="../admin/proccess/<?php echo $product['gambar']; ?>" alt="product-image" class="img-fluid" style="max-width:50px" />
                            </div>
                            <div class="col">
                              <span><?php echo $product['nama_produk']; ?></span>
                            </div>
                            <div class="col">
                ...
                <div class="mb-3">
                  <label for="product-description" class="form-label">Deskripsi Tambahan Pengajuan (Optional)</label>
