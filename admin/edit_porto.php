      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card position-relative">
            ...
            <div class="card-body">
              <form action="proccess/edit_porto.php" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                  ...
                  <input type="hidden" name="porto_id" value="<?php echo $_GET['porto_id']?>">
                  <input type="text" class="form-control" id="nama_porto" name="nama_porto" value="<?php echo $nama?>" required>
                </div>
                <div class="mb-3">
                  <label for="game-title" class="form-label">Nama PT</label>
                  <input type="text" class="form-control" id="nama_pt" name="nama_pt" value="<?php echo $nama_pt?>" required>
                </div>
                <div class="mb-3">
                  <label for="product-description" class="form-label">Deskripsi Game</label>
                  <textarea class="form-control" id="ket_porto" name="ket_porto" rows="3" required><?php echo $ket?></textarea>
                </div>
